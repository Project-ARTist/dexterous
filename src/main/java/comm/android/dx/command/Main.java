...
package comm.android.dx.command;
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; i++) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    comm.android.dx.command.dexer.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--dump")) {
                    comm.android.dx.command.dump.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--annotool")) {
                    comm.android.dx.command.annotool.Main.main(
                            without(args, i));
                    break;
                } else if (arg.equals("--find-usages")) {
                    comm.android.dx.command.findusages.Main.main(without(args, i));
                    break;
