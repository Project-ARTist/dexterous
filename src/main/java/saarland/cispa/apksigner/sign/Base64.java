...
public class Base64 {
    ...
    static {
        ...
        try {
            ...
            Log.i(TAG, clazz.getName() + " is available.");
        } catch (ClassNotFoundException x) {
        } // Ignore
        catch (Exception x) {
            Log.e(TAG, "Failed to initialize use of android.util.Base64", x);
        }
        ...
        try {
            ...
            Log.e(TAG, "Failed to initialize use of org.bouncycastle.util.encoders.Base64Encoder", x);
        }
